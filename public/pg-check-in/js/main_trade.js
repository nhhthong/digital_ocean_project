...
function save() {
    ...
    */
    ...
    var params =  'latitude=' + latitude + '&longitude=' + longitude 
    			  ...
    			  + '&shift=' + shift + '&isimg1=' + click_button1 + '&isimg2=' + click_button2 + '&imagedata1=' + canvasData1 + '&imagedata2=' + canvasData2 ;
...
function getLocation() {
    ...
    if (navigator.geolocation) {
    	...
    	navigator.geolocation.getCurrentPosition(function(position,showError) {
		 ...
		 document.getElementById('address_input').value  = location.results[0].formatted_address;
                 document.getElementById('address_input1').value  = location.results[0].formatted_address;
				
                $('#tp').html(location.results[0].address_components[5].long_name);   
