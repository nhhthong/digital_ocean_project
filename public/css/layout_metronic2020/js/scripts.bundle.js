...
KTUtil.ready(function() {
    ...
    // Init Aside Mobile
    // Fix: only kt_aside_menu_wrapper hover open aside. Old:kt_aside
    KTLayoutAside.init('kt_aside_menu_wrapper');

    // Init Aside
    KTLayoutAsideMobile.init('kt_aside');
...
var KTLayoutAsideMobile = function() {
    // Private properties
    var _body;
    var _element;
    var _offcanvasObject;
