$(document).ready(function(){
    ...
    /*function setListListener(){
        $(".panel-list .main-content").click(function(){
            $(".list-hidden-content").slideUp('normal');
            $(".list-hidden-content").children(".hidden-icon-set").css({"right":"55px","opacity":0});
            if($(this).siblings(".list-hidden-content").css('display')=='none'){
                $(this).siblings(".list-hidden-content").slideDown('normal');
    ...
    /*function setListListener(){
        $(".panel-list .main-content .triangle-top-left").click(function(){
            $(".list-hidden-content").slideUp('normal');
            $(".list-hidden-content").children(".hidden-icon-set").css({"right":"55px","opacity":0});
            if($(this).parent().siblings(".list-hidden-content").css('display')=='none'){
                $(this).parent().siblings(".list-hidden-content").slideDown('normal');
                $(this).parent().siblings(".list-hidden-content").children(".hidden-icon-set").css({"right":"5px","opacity":1});
            }else{
                $(this).parent().siblings(".list-hidden-content").slideUp('normal');
                $(this).parent().siblings(".list-hidden-content").children(".hidden-icon-set").css({"right":"55px","opacity":1});
            }
        });
    }*/
